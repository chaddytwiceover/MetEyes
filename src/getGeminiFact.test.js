...
describe('getGeminiFact', () => {
  ...
  const mockSuccessResponse = {
    text: 'The Starry Night by Vincent van Gogh is one of the most recognizable paintings in Western art. Created during his stay at the Saint-Paul-de-Mausole asylum, it showcases his distinctive post-impressionist style with bold, swirling brushstrokes that convey movement and emotion.'
  };
    ...
    test('should successfully call Gemini API and return valid response', async () => {
      ...
      expect(global.fetch).toHaveBeenCalledWith(
        API.constants.GEMINI_API_PROXY_URL,
        {
          ...
          body: JSON.stringify({
            prompt: `Tell me an interesting fact or provide a brief analysis about the artwork titled "The Starry Night" by Vincent van Gogh, created around 1889. Focus on its historical context, artistic style, or significance. Keep it concise, around 2-3 sentences.`
          })
        }
      );
    });
